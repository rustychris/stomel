...
# FIX: This might be relying on old CGAL interfaces.
...
class Region(object):
    ...
    def identifier(self):
        return ":".join(filter(None,self.items.values()))
